...
<html>
  ...
  <body >
      ...
      <div class="levi" style="display: none; width: 0px; float: left; background-color: lightgreen;height: 100%;">
          <br />
          <?php
          include 'login.php';
      ...
      <div style="float: none; display: inline-block;min-width: inherit; height: 100%;">
          ...
          if($_GET['id']==11) include 'novaloz.php';
              ...
              echo '<h4 style=" text-decoration: underline;">Zadnja promjena: ',  file_get_contents('datum.txt'),' sati</h4><br/><br/>';
              include 'vr_dj1.php';
          }
